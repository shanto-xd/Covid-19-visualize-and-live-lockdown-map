      ...
      function createElements(){
        ...
        $legend.appendTo('#legend');
				...
				$('#abt-modal').click( function () {
					...
					$(".modal-body").empty().append('<p>This map is an attempt at tracking COVID-19 cases in Bangladesh at the district level. The source of this data is news reports and Division bulletins, and the official <a href="http://www.iedcr.gov.bd/" target="_blank">numbers from MoHFW</a> are only used as a reference. The <a href="https://docs.google.com/spreadsheets/d/e/2PACX-1vS0Ajb1XjkCkqU3ZOFC0U4VboEYyHSLz6adblkI5P7uMdUSu4KmX7BYbf3nxh7AJPPj_78Wmoi0ZKEW/pubhtml#" target="_blank">data is compiled here</a>.</p><p>Some issues regarding this exercise: a) should the cases be marked where the patient is currently quarantined or where they reside (or where spread may have happened); Please see <a href="https://www.corona.gov.bd/" target="_blank">corona.gov.bd</a> for more up-to-date numbers.</p><p>Feedback is more than welcome. Please DM <a href="https://github.com/guneetnarula/covid19-in" target="_blank">create an issue here</a>, or write an <a href="mailto:vedo96@gmail.com?subject=covid19 Bangladesh district map feedback">email</a>. Thank you!</p><hr><p>If you need help or more information about the pandemic, consider the following links:</p><ul><li><a href="https://www.who.int/health-topics/coronavirus" target="_blank">World Health Organization</a></li><li><a href="http://www.iedcr.gov.bd/" target="_blank">Institute of Epidemiology Disease Control and Research(IEDCR)</a></li><li><a href="https://github.com/datameet/covid19" target="_blank">DataMeet Archive on CoVID19</a></li><li><a href="https://www.corona.gov.bd/" target="_blank">Bangladesh COVID-19 tracker</a></li><li><a href="https://ourworldindata.org/coronavirus" target="_blank">Our World in Data</a></li><li></ul>');
				});
